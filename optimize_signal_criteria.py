...
Usage:
    python optimize_signal_criteria.py
    python optimize_signal_criteria.py --strategy trend_following_stable
    python optimize_signal_criteria.py --days 30 --auto-apply
"""
